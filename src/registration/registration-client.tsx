...
export function RegistrationClient({ member }: { member: Member | null }) {
    ...
    const [joiningType, setJoiningType] = useState<JoiningType | null>(null);
            ...
            <Card className="w-full max-w-lg mx-auto">
                ...
                <CardContent className="space-y-4">
                     <div onClick={() => setJoiningType('New')} className="p-4 border rounded-lg hover:bg-muted cursor-pointer">
                        ...
                        <p className="text-sm text-muted-foreground">আমি একজন নতুন সদস্য হিসেবে যোগদান করতে চাই। আমার দেয় চলতি বছরের জানুয়ারি মাস থেকে গণনা করা হবে।</p>
                    </div>
    ...
    <form onSubmit={handleSubmit}>
      <Card className="w-full max-w-4xl shadow-lg mx-auto">
        <CardHeader className="text-center">
          ...
          <CardDescription> বন্ধন'১৭ তে যোগদানের জন্য আবেদন করুন ( ধরন: {joiningType} )</CardDescription>
        </CardHeader>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                    <div className="space-y-2">
                        ...
                        {defaultValues.photoUrl && <Image src={defaultValues.photoUrl} alt="Current Photo" width={100} height={100} className="rounded-md border p-1" />}
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="nidCopy">জাতীয় পরিচয়পত্র / জন্ম নিবন্ধনের কপি</Label>
                         {defaultValues.nidCopyUrl && <Image src={defaultValues.nidCopyUrl} alt="Current NID" width={150} height={100} className="rounded-md border p-1" />}
                    ...
                    <div className="space-y-2 md:col-span-2">
                        ...
                        {defaultValues.bankStatementUrl && <Image src={defaultValues.bankStatementUrl} alt="Current Bank Statement" width={150} height={100} className="rounded-md border p-1" />}
